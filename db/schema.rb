...
ActiveRecord::Schema.define(version: 20_210_623_014_307) do
  ...
  create_table 'buyers_infos', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.index ['order_id'], name: 'index_buyers_infos_on_order_id'
  end
  ...
  add_foreign_key 'buyers_infos', 'orders'
